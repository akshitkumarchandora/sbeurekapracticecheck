...
public class CartController {
	...
	public void deleteCartItem(@PathVariable String userId,@PathVariable long movieId) throws UserNotExistsException, CartEmptyException, MenuItemNotFoundException
	{
